...
import { CreateConditionPrecedent } from '../Form/AddNewCondition';
...
export const AddCondition = ({ conditionId }: Props) => {
  ...
  const actionButtons: Array<React.ReactNode> = [
    <Box ml={{ mobile: 12, desktop: 0 }}>
      <PrimaryIconButton
        isLoading={isLoading}
        type="submit"
        buttonTitle={`${isEditing ? 'Save Changes' : 'Create Condition '}`}
