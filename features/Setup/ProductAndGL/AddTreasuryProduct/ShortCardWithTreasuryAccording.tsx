...
import { PersonalTreasuryDetailsForm } from '../Form/CreateTreasuryProduct/PersonalTreasuryDetailFormWrapper';
import { InterestTreasuryChargesForm } from '../Form/CreateTreasuryProduct/interestTreasuryCharges';
import { GeneralLedgerTreasuryForm } from '../Form/CreateTreasuryProduct/GeneralLedgerTreasury';
import { OtherTreasuryDetailsForm } from '../Form/CreateTreasuryProduct/OtherTreasuryDetails';
import {
  ChevronDown,
  CompletedStepIcon,
  UnCompletedStepIcon
...
export const ShortCardTreasuryWithAccordion = ({
  cardTitle,
  cardKey,
  completed,
  titles,
  ...
  const { frequency: feq } = useGetAllLoanTerm();
