...
import { CreateDocumentForm } from '@/features/Setup/KYC/Forms/CreateDocumentForm';

type Props = {
  documentId?: string;
};

export const CreateDocument = ({ documentId }: Props) => {
  ...
  const actionButtons: Array<React.ReactNode> = [
    <Box ml={{ mobile: 12, desktop: 0 }}>
      <PrimaryIconButton
        isLoading={isLoading}
        type="submit"
        buttonTitle={`${isEditing ? 'Save Changes' : 'Create Document'}`}
