        ...
        <Box ml={{ desktop: 2 }}>
          <Grid container spacing={2}>
            ...
            <Grid
              ...
              mobile={12}
              ml={{ mobile: 3, tablet: 0 }}
              mr={{ tablet: 1, desktop: 0, mobile: 4 }}
              whiteSpace={{ mobile: 'break-spaces' }}
              lineHeight={{ mobile: 2, tablet: 0 }}
              tablet={6}
              justifyContent="center"
            >
            ...
            <Grid
              item={isTablet}
              marginRight={{ mobile: '40px', desktop: '25px' }}
              container={isMobile}
              mobile={12}
              tablet={12}
              justifyContent="center"
...
export const ReactivationContainer = () => {
  return (
    <CustomerServiceContainer
      ...
      modalTitle="Add Lien"
      buttonTitle="Lien"
      tableTitle="View All Deactivated Accounts"
