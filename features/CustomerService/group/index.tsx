...
export const actionButtons: any = [
  <Box sx={{ display: 'flex' }} ml={{ mobile: 2, desktop: 0 }}>
    <Link href="/customer-service/add-group">
      <PrimaryIconButton
...
const groupOverviewOptions: IOptions[] = [
  { buttonTitle: 'View Details', link: '/customer-service/manage-mandate' },
  {
    buttonTitle: 'Add group members',
    link: '/customer-service/add-group',
  },
];
const customerOverviewActions: React.FC = () => {
  return <ActionMenu options={groupOverviewOptions} useDefault={false} />;
};
