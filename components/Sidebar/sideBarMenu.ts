...
export const sideBarMenu: SidebarMenuItem[] = [
  ...
  },
  {
    ...
    subMenuItems: [
      ...
      // On hold untill Loan module is done
      // {
  ...
  },
  {
    ...
    hideMenuItem: false,
    subMenuItems: [
      { name: 'Company', link: '/setup/company/', hideSubMenuItem: false },
      {
        name: 'Product and GL',
        link: '/setup/product-gl/',
        hideSubMenuItem: false
      },
      {
      ...
      { name: 'KYC', link: '/setup/kyc/', hideSubMenuItem: false }
    ]
  }
