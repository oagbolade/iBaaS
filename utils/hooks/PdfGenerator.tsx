...
pdf.addImage(logoImage, 'PNG', 10, 5, 45, 25); 
// Report Title
pdf.setFontSize(21);
pdf.setFont('custom', 'bold');
pdf.text(`${reportType} Report`, 150, 15); // centered vertically with logo

// First separator line
pdf.setLineWidth(0.2);
pdf.setDrawColor(200, 200, 200);
pdf.line(10, 35, 420 - 10, 35); // full width, landscape

// Report Generated By
pdf.setFont('custom', 'normal');
pdf.setFontSize(16);
pdf.text('Report Generated By:  ', 10, 42);
pdf.setFont('custom', 'bold');
pdf.text(`${getStoredUser()?.fullName}`, 60, 42); // aligned next to label
pdf.setFont('custom', 'normal');
pdf.text(`User ID: ${getStoredUser()?.profiles?.userid}`, 10, 55);

// Date
pdf.setFont('Newsreader', 'normal');
pdf.text(`Date: ${getCurrentDate()}`, 250, 42);

// Second separator line
pdf.setLineWidth(0.1);
pdf.line(10, 60, 420 - 10, 60);

// Report Description
pdf.setFont('Newsreader', 'bold');
pdf.setFontSize(16);
pdf.text(reportDescription, 10, 70);
  ...
  const totalPageWidth = 420; // A3 landscape width in mm
  ...
  autoTable(pdf, {
    ...
    headStyles: {
      ...
      fontSize: 13, // Reduced font size for headers
      font: 'Newsreader',
      halign: 'left'
    },
    ...
    bodyStyles: {
      fontSize: 13, // Reduced font size for body
      font: 'Newsreader',
